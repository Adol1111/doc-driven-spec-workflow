...
然后你可以交互式选择要安装的 skills，或者显式安装全部：

```bash
npx skills add Adol1111/doc-driven-spec-workflow --skill '*'
```

如果你只想安装某一个阶段，也可以按 skill 名单独安装：
