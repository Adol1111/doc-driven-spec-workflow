...
The docs scaffold exists. `docs/tasks/m1-private-beta/index.md` says `Roadmap confirmed: yes`, and `docs/tasks/m1-private-beta/authentication/session-timeout-policy/task.md` is the selected current task with no blocking dependencies or prior checkpoints.
